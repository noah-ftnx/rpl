#ifndef RPL_DS_10G_TEST_09_G_BELLMAN_FORD_PATH_H_
#define RPL_DS_10G_TEST_09_G_BELLMAN_FORD_PATH_H_
...
void run_tests() {
  test(input1(), 0, 2, {0, 1, 2});
}

#endif  // RPL_DS_10G_TEST_09_G_BELLMAN_FORD_PATH_H_
